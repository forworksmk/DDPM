...
def get_ddpm_constants(
    ...
    #### Code Review1 ####
    #### Insert code here ####
    # Compute ddpm constants
    # You can check the following constants in lecture6 slide 10, 11
    # alphas                    = 1.0 - betas
    # alphas_bar                =  
    # alphas_bar_prev           = 
    # sqrt_recip_alphas         = 
    ...
    alphas = 1.0 - betas
    alphas_bar = np.cumprod(alphas, axis=0) # cumulative product
...
def forward_sample(x0_batch,t_batch,dc,M=None,noise_scale=1.0):
    ...
    #### Insert code here ####
    # Jump diffusion
    # you can use sqrt_alphas_bar_t, sqrt_one_minus_alphas_bar, noise_scale, noise
    # lecture6 silde 4
    # xt_batch =  # [B x C x ...]
